...
int main()
{
    ...
    unsigned int fragmentShaderSkin = glCreateShader(GL_FRAGMENT_SHADER);
    ...
    unsigned int shaderProgramSkin = glCreateProgram();
    ...
    glShaderSource(fragmentShaderPink, 1, &fragmentShader3Source, NULL);
    glCompileShader(fragmentShaderPink);
    glShaderSource(fragmentShaderRed, 1, &fragmentShader4Source, NULL);
    glCompileShader(fragmentShaderRed);
    glShaderSource(fragmentShaderSkin, 1, &fragmentShader5Source, NULL);
    glCompileShader(fragmentShaderSkin);
    glShaderSource(fragmentShaderWhite, 1, &fragmentShader6Source, NULL);
    glCompileShader(fragmentShaderWhite);
    glShaderSource(fragmentShaderColor, 1, &fragmentShader7Source, NULL);
    ...
    //Triangulo de color piel
    glAttachShader(shaderProgramSkin, vertexShader);
    glAttachShader(shaderProgramSkin, fragmentShaderSkin);
    glLinkProgram(shaderProgramSkin);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangulo3), triangulo3, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);	// Vertex attributes stay the same
    glEnableVertexAttribArray(0);
    //Triangulo 4
    //------------------------
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangulo4), triangulo4, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);	// Vertex attributes stay the same
    glEnableVertexAttribArray(0);
    //Triangulo 5
    //------------------------
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangulo5), triangulo5, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);	// Vertex attributes stay the same
    glEnableVertexAttribArray(0);
    //Triangulo 6
    //------------------------
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangulo6), triangulo6, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);	// Vertex attributes stay the same
    glEnableVertexAttribArray(0);
    //Triangulo 7
    //------------------------
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(triangulo7), triangulo7, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);	// Vertex attributes stay the same
    glEnableVertexAttribArray(0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //Triangulo 5
        glUseProgram(shaderProgramSkin);
        glBindVertexArray(VAOs[4]);
        glDrawArrays(GL_TRIANGLES, 0, 3);
    ...
    glDeleteProgram(shaderProgramSkin);
